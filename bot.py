        ...
        if step == 0:
            if text == "Частые вопросы":
                ...
                vk.messages.send(
                    ...
                    "Если вы затрудняетесь с выбором – мы с удовольствием\n" "поможем!\n"
                    "Вы можете описать, что примерно вы хотели бы: в каком\n" "цвете, для каких целей и другие характеристики.\n"
                    "Мы сделаем все возможное, чтобы вы нашли ту самую\n" "модель 🤍\n\n"
                    "Если вы не нашли здесь свой вопрос, то напишите его и\n" "менеджер свяжется с вами!",
                    random_id=0,
